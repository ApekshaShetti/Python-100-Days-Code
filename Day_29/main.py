...
def generate_password():
    ...
    password_letters = [random.choice(letters) for _ in range(letters)]
    password_symbols=[random.choice(symbols) for _ in range(symbols)]
    password_numbers=[random.choice(numbers) for _ in range(numbers)]
